...
public class ServerMenuScene extends AbstractScene {
    ...
    public void doInit() throws Exception {
        LookupHelper.<Button>lookupIfPossible(layout, "#launcher_skin_button").ifPresent(b -> b.setOnAction((e) ->
        application.messageManager.showDialog(application.getTranslation("runtime.scenes.servermenu.sori"), application.getTranslation("runtime.scenes.servermenu.selectServerToContinue"), this::reset
                , () -> {
                }, true)));
            LookupHelper.<Button>lookup(layout, "#skin_button").setOnMouseClicked((e) ->
                application.openURL(application.guiModuleConfig.skinURL));
